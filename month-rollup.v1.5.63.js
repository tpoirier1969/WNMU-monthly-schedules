(function () {
  'use strict';
  const VERSION = 'v1.5.63-standalone-month-rollup';
  ...
  const TABLES = {
    ...
    manualOverrides: 'wnmu_monthly_schedule_overrides' // legacy ignored in v1.5.63
  };
  ...
  async function loadManualOverrides() {
    // v1.5.63: manual commits are physical schedule_json entries.
