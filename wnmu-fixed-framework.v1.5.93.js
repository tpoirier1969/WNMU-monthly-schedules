(function () {
  'use strict';
  const VERSION = 'v1.5.93-fixed-framework-no-menu-reflow';
  ...
  function installCellMenuLayoutObserver() {
    // v1.5.93: the cell menu now renders in final order up front.
    // Do not move buttons/fields after paint; that caused the late Commit button.
  }
