(function () {
  'use strict';
  const VERSION = 'v1.5.17-no-inline-month-rollup-current-cache-only';
  ...
  function updateRollupLink() {
    ...
    link.href = `month-rollup.v1.5.17.html?channel=${encodeURIComponent(channel)}&month=${encodeURIComponent(month)}&v=1.5.17`;
  }
