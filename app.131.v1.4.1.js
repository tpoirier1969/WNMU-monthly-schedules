window.WNMU_MONTHLY_PAGE_CONFIG = {
  "buildVersion": "v1.5.78",
  "packageVersion": "v1.5.78",
  "channelCode": "13.1",
  "channelLabel": "WNMU1HD",
  "registryFile": "data/month-registry.v1.4.1.json",
  "sharedRendererFile": "wnmu-monthly-shared.v1.3.1.js",
  "loaderVersion": "v1.5.78",
  "useSourceInId": false,
  "tagOrder": ["newSeries","newSeason","highlight","oneOff","monthlyTopic","other","fundraiser","programmersChoice","holiday","noteworthy","educational","local","michigan"],
  "tagPriority": ["newSeries","newSeason","holiday","fundraiser","programmersChoice","michigan","local","educational","highlight","noteworthy","other","oneOff","monthlyTopic"],
  "tagMeta": {
    ...
    "other": { "label": "Custom", "color": "var(--other)" },
