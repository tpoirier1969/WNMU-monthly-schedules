(function () {
  'use strict';
  const VERSION = 'v1.5.23-no-inline-rollup-cache-prune-header-safe';
  ...
  function updateRollupLink() {
    ...
    link.href = `month-rollup.v1.5.23.html?channel=${encodeURIComponent(channel)}&month=${encodeURIComponent(month)}&v=1.5.23`;
  }
