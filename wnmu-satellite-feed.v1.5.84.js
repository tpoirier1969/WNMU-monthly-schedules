(function () {
  const VERSION = 'v1.5.84-satellite-feed-all-weeks-full-grid-painter';
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .program-cell.wnmu-satellite-feed::before {
  ...
  function applySatelliteVisual(cell, isSatellite) {
    ...
    cell.classList.remove('wnmu-satellite-feed');
    cell.dataset.satelliteFeed = 'false';
  ...
  function schedulePaint(root) {
    // v1.5.84: always repaint the whole rendered grid, not just the most recent
