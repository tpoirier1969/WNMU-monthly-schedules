...
(function () {
  ...
  const BUILD_VERSION = 'v1.4.16-visible-hole-publish-parser';
  const state = { parsed: {} };
  ...
  function buildMonthData(entries, monthKey, channelLabel) {
    ...
    const schedule = { version: `${channelLabel} ${monthKey} imported`, channel: channelLabel, month: monthKey, generatedAt: new Date().toISOString(), sourcePolicy: 'PDF import via month builder v1.4.16 visible-hole publish parser', days, weeks };
