(function () {
  'use strict';
  const VERSION = 'v1.5.73-resize-measure-throttle';
  ...
  function installMeasurementHooks() {
    ...
    if (target && 'MutationObserver' in window) { const observer = new MutationObserver(() => scheduleMeasureStickyBlock(60)); observer.observe(target, { childList:true, subtree:true }); }
  }
  function activate() {
