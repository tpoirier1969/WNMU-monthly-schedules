(function () {
  'use strict';
  const VERSION = 'v1.5.20-no-inline-month-rollup-current-cache-only-rollup-layout-restored';
  ...
  function updateRollupLink() {
    ...
    link.href = `month-rollup.v1.5.20.html?channel=${encodeURIComponent(channel)}&month=${encodeURIComponent(month)}&v=1.5.20`;
  }
