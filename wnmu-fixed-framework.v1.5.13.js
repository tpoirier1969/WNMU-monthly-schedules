(function () {
  'use strict';
  const VERSION = 'v1.5.13a-single-scroll-content-restore';
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      /*
        ...
        behave like one normal page. Previous hotfixes let .weeks-panel and
        .month-panel become separate scroll panes, which made the month checkbox
        rollup appear like a second window. Keep main.page as the ONLY vertical
        scrolling region so the rollup remains at the natural bottom of the page.
      */
      ...
      /*
        ...
        the schedule work area while preserving the one-page vertical flow.
      */
