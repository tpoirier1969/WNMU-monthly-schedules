(function () {
  'use strict';
  const VERSION = 'v1.5.39-smoother-scroll-no-content-visibility';
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      /*
        v1.5.39: favor smoother manual scrolling over deferred offscreen painting.
      ...
      */
      ...
      body.wnmu-fixed-framework-active table.screen-week-grid thead th {
        ...
        box-shadow: inset 0 0 0 1px #111, 0 1px 0 #111 !important;
