(function () {
  ...
  const VERSION = 'v1.5.83-visible-custom-planning-label';
  ...
  function allMenuTags() { return tagOrderBase().filter(tag => tag !== SATELLITE_KEY); }
  ...
  function explicitFalseTags() { return {}; }
