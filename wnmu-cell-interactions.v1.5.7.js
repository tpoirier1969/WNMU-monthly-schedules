(function () {
  ...
  const VERSION = 'v1.5.7-box-size-menu-restored';
  ...
  function clearFromCellMenu() {
    ...
    selectedTarget = target;
    writeCanonicalRecord(target, { text: '', durationMin: 30, tags: {}, cleared: true });
