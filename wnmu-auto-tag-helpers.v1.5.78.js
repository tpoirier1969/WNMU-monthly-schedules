(function () {
  ...
  function renderTags(cell, tags){
    ...
    if (otherLabel) cell.dataset.wnmuOtherLabel = otherLabel;
  ...
  function writeExplicitTagsForMenu(menu, tags){
    ...
    const writeRecord = (recordKey) => {
      ...
      marks[recordKey] = { ...existing, tags: { ...clean }, otherLabel, planningOtherLabel: otherLabel, customPlanningLabel: otherLabel, customTagLabel: otherLabel };
    };
