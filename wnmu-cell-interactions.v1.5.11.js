(function () {
  ...
  const VERSION = 'v1.5.11-scoped-note-layer';
  ...
  function overlayHostForTarget(target) {
    return target?.cell?.closest?.('.week-grid-wrap')
      || target?.cell?.closest?.('.screen-host')
