(function () {
  ...
  const PACKAGE_VERSION = 'v1.5.102';
  const PACKAGE_LABEL = 'episode-retention guarded import recovery';
  ...
  function setSingleFlag() {
    ...
    if (builderBadge && /month builder/i.test(document.title || '')) {
      builderBadge.textContent = 'v1.4.24 episode-retention guarded import';
    }
  }
