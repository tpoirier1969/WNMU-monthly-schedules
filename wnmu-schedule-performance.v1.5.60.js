(function () {
  'use strict';
  const VERSION = 'v1.5.60-episode-field-width';
  ...
  function updateRollupLink() {
    ...
    link.href = `month-rollup.v1.5.60.html?channel=${encodeURIComponent(channel)}&month=${encodeURIComponent(month)}&v=1.5.60`;
  }
  ...
  function widenEpisodeFields() {
    try {
      ...
      style.textContent = `
        /* v1.5.60: make Episode # controls about four characters wider without disturbing other compact fields. */
        input[id*="episode" i],
