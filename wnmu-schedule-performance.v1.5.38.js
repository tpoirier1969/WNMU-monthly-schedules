(function () {
  'use strict';
  const VERSION = 'v1.5.38-episode-field-width';
  ...
  function updateRollupLink() {
    ...
    link.href = `month-rollup.v1.5.38.html?channel=${encodeURIComponent(channel)}&month=${encodeURIComponent(month)}&v=1.5.38`;
  }
  ...
  function widenEpisodeFields() {
    try {
      ...
      style.textContent = `
        /* v1.5.38: make Episode # controls about four characters wider without disturbing other compact fields. */
        input[id*="episode" i],
