(function () {
  ...
  const PACKAGE_VERSION = 'v1.5.105';
  const PACKAGE_LABEL = 'import weekday-header anchor and episode-row fix';
  ...
  function setSingleFlag() {
    ...
    if (builderBadge && /month builder/i.test(document.title || '')) {
      builderBadge.textContent = 'v1.4.27 weekday-header anchored import';
    }
  }
