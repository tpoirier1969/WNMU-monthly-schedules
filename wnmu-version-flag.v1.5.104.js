(function () {
  ...
  const PACKAGE_VERSION = 'v1.5.104';
  const PACKAGE_LABEL = 'import weekday-anchor and episode-row fix';
  ...
  function setSingleFlag() {
    ...
    if (builderBadge && /month builder/i.test(document.title || '')) {
      builderBadge.textContent = 'v1.4.26 day-anchored episode-row import';
    }
  }
