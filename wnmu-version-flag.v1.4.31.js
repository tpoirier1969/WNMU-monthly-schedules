(function () {
  const VERSION = 'v1.4.31-version-flag-keeper';
  ...
  function helperBits() {
    ...
    if (window.WNMU_BLANK_SLOT_CONTEXT_MENU_VERSION) bits.push('blank overlay fix');
  ...
  function setFlag() {
    ...
    if (!flag.textContent.includes('v1.4.31')) flag.textContent = wanted;
  }
