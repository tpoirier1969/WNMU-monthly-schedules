(function () {
  ...
  const KNOWN_PARTS = [
    ...
    { key: 'home', label: 'Home page shell', version: 'index.html v1.5.32' },
    { key: 'schedule-shell', label: 'Schedule page shell', version: 'index131/133 HTML v1.4.1 + package v1.5.32' },
    ...
    { key: 'manual-programs', label: 'Manual program entries', global: 'WNMU_MANUAL_PROGRAMS_VERSION', fallback: 'v1.5.32 true in-table manual programs' },
    ...
    { key: 'framework', label: 'Fixed framework / scroll area', global: 'WNMU_FIXED_FRAMEWORK_VERSION', fallback: 'v1.5.32 true in-table manual programs' },
  ...
  function pageShellVersion() {
    ...
    if (page === 'index.html' || !page.includes('.html')) return 'Home page shell v1.5.32';
    if (/index13[13]\.v1\.4\.1\.html/i.test(page)) return `${page} shell v1.4.1 + package v1.5.32`;
    if (/month-builder\.v1\.4\.1\.html/i.test(page)) return `${page} shell v1.4.1 + package v1.5.32`;
    return `${page} + package v1.5.32`;
  }
