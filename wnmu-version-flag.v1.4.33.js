(function () {
  const VERSION = 'v1.4.33-version-flag-keeper';
  ...
  function helperBits() {
    ...
    if (window.WNMU_BLANK_SLOT_CONTEXT_MENU_VERSION) bits.push('blank note single text');
  ...
  function setFlag() {
    ...
    if (!flag.textContent.includes('v1.4.33')) flag.textContent = wanted;
  }
