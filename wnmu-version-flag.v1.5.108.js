(function () {
  ...
  const PACKAGE_VERSION = 'v1.5.108';
  const PACKAGE_LABEL = 'deferred right-click menu save and custom planning tag fix';
  ...
  function setSingleFlag() {
    ...
    if (builderBadge && /month builder/i.test(document.title || '')) {
      builderBadge.textContent = 'v1.4.20 strict import parser';
    }
  }
