(function () {
  const VERSION = 'v1.4.36-version-flag-keeper';
  ...
  function helperBits() {
    ...
    if (window.WNMU_BLANK_SLOT_CONTEXT_MENU_VERSION) bits.push('blank box overlay');
  ...
  function setFlag() {
    ...
    if (!flag.textContent.includes('v1.4.36')) flag.textContent = wanted;
  }
