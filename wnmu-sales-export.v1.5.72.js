(function () {
  'use strict';
  const VERSION = 'v1.5.72-sales-hsb-4-99-palette';
  ...
  function injectStyles() {
    ...
    style.textContent = `
      :root {
        ...
        --sales-kids:#fcfbf2; --sales-health:#f2fcf7; --sales-financial:#faf2fc; --sales-news:#f2f7fc;
        --sales-food:#fcf7f2; --sales-home:#fcfaf2; --sales-travel:#f2fcfb; --sales-michigan:#f2f9fc; --sales-local:#f2fcf3;
        --sales-arts:#f6f2fc; --sales-environmental:#f6fcf2; --sales-science:#f2fbfc; --sales-history:#fcf8f2; --sales-documentary:#f4f2fc;
        --sales-drama:#fcf2fa; --sales-talk:#f2f7fc; --sales-native:#fcf6f2; --sales-variety:#fbfcf2; --sales-choice:#f5fcf2; --sales-specials:#f2f4fc; --sales-fundraiser:#fcf2f6; --sales-program:#fafbfc; --sales-blank:#ffffff;
      }
  ...
  function render(row) {
    ...
    const scheduleHref = channel === '13.3' ? `index133.v1.4.1.html?month=${encodeURIComponent(month)}&v=1.5.72` : `index131.v1.4.1.html?month=${encodeURIComponent(month)}&v=1.5.72`;
  ...
  async function start() {
    ...
    try {
      ...
      const root = document.getElementById(ROOT_ID);
      if (root) root.innerHTML = `<div class="sales-error"><strong>Could not build Sales View.</strong><br>${esc(err.message || String(err))}<br><br><small>v1.5.72 note: sales category colors use an extra-light pastel target: about 4% saturation and 99% brightness; fundraiser detection still uses only exact date/time placements from the actual Fundraising Schedule.</small></div>`;
    }
  }
