window.WNMU_MONTHLY_PAGE_CONFIG = {
  ...
  "useSourceInId": true,
  "tagOrder": ["newSeries","newSeason","highlight","oneOff","monthlyTopic","other","fundraiser","programmersChoice","holiday","noteworthy","educational","local","arts"],
  "tagPriority": ["newSeries","newSeason","holiday","fundraiser","programmersChoice","arts","educational","highlight","noteworthy","other","local","oneOff","monthlyTopic"],
  "tagMeta": {
