-- WNMU Monthly Schedules v1.5.30
-- Manual program overrides table for explicit Commit to Schedule workflow
-- Run this once in Supabase SQL Editor before using v1.5.30 manual-program sync.
...
-- v1.5.30 cleanup: older experimental builds could copy staged overlay notes into this
...
set is_active = false,
    updated_by = 'v1.5.30-auto-import-cleanup',
    updated_at = now()
