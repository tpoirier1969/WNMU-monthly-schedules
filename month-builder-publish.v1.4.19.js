...
(function () {
  ...
  const BUILD_VERSION = 'v1.4.19-episode-code-title-guard';
  const state = { parsed: {} };
  ...
  function buildMonthData(entries, monthKey, channelLabel) {
    ...
    const schedule = { version: `${channelLabel} ${monthKey} imported`, channel: channelLabel, month: monthKey, generatedAt: new Date().toISOString(), sourcePolicy: 'PDF import via month builder v1.4.19 episode-code guarded positioned-column parser', days, weeks };
