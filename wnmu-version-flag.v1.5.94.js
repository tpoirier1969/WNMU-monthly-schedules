(function () {
  ...
  const PACKAGE_VERSION = 'v1.5.94';
  const PACKAGE_LABEL = 'Bansemer import alignment and smoother weekly grid';
  const KNOWN_PARTS = [
    { key: 'package', label: 'Delivered package', version: `${PACKAGE_VERSION} ${PACKAGE_LABEL}` },
    { key: 'schedule-shell', label: 'Schedule page shell', version: 'index131/133 HTML v1.4.1 + package v1.5.93' },
