(function () {
  'use strict';
  const VERSION = 'v1.5.69-sales-pastel-prime-topic-fix';
  ...
  function injectStyles() {
    ...
    style.textContent = `
      :root {
        ...
        --sales-kids:hsl(48 82% 88%); --sales-health:hsl(150 55% 89%); --sales-financial:hsl(286 58% 89%); --sales-news:hsl(214 68% 89%);
        --sales-food:hsl(28 78% 89%); --sales-home:hsl(40 68% 88%); --sales-travel:hsl(174 62% 88%); --sales-michigan:hsl(201 66% 89%); --sales-local:hsl(124 52% 89%);
        --sales-arts:hsl(265 60% 90%); --sales-environmental:hsl(104 58% 88%); --sales-science:hsl(188 62% 89%); --sales-history:hsl(33 72% 88%); --sales-documentary:hsl(246 60% 90%);
        --sales-drama:hsl(310 58% 90%); --sales-talk:hsl(210 38% 90%); --sales-native:hsl(24 64% 87%); --sales-variety:hsl(70 64% 88%); --sales-choice:hsl(92 54% 89%); --sales-specials:hsl(230 58% 90%); --sales-fundraiser:hsl(345 64% 89%); --sales-program:#eef1f5; --sales-blank:#ffffff;
      }
  ...
  function render(row) {
    ...
    const scheduleHref = channel === '13.3' ? `index133.v1.4.1.html?month=${encodeURIComponent(month)}&v=1.5.69` : `index131.v1.4.1.html?month=${encodeURIComponent(month)}&v=1.5.69`;
  ...
  async function start() {
    ...
    try {
      ...
      const root = document.getElementById(ROOT_ID);
      if (root) root.innerHTML = `<div class="sales-error"><strong>Could not build Sales View.</strong><br>${esc(err.message || String(err))}<br><br><small>v1.5.69 note: sales palette tuned to light pastels; Tuesday/Friday 9 PM and Friday 8:30 PM topic fallback rules updated; fundraiser detection still uses only exact date/time placements from the actual Fundraising Schedule.</small></div>`;
    }
  }
